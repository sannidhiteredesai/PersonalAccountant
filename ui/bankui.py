...
class BankPage(tk.Frame):
    ...
    def _display_each_bank_entry(self):
        ...
        for bank in self.banks.get_all_bank_details():
            ...
            ttk.Label(self.interior, text='Address: '+bank['bank_address'], foreground=fg_color, background=bg_color,
                      anchor='w', wraplength=details_min_size).grid(row=row + 3, column=0, sticky='ew', rowspan=4, padx=(10, 0))
            ...
            # Bank Codes
            ttk.Label(self.interior, text='IFSC Code: '+bank['bank_ifsc_code'], foreground=fg_color, background=bg_color,
                      anchor='w').grid(row=row+2, column=2, sticky='ew', padx=(10, 0))
            ttk.Label(self.interior, text='MICR Code: '+bank['bank_micr_code'], foreground=fg_color, background=bg_color,
    ...
    def _edit_bank(self, bank):
        print('bank = '+str(bank))
        popup = tk.Tk()
        label = ttk.Label(popup, text=bank['bank_name'])
